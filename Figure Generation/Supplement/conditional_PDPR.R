Courtney Smith - Nightingale Analysis - BOLT-LMM - Conditional analysis - PDPR
# Goal of script: Plot conditional analysis results for PDPR
...
v <- data.frame(conditions=c("Marginal","rs370014171 and rs12924171","rs370014171 and rs8061221","All Three Variants","rs8061221 and rs12924171","rs370014171","rs8061221","rs12924171"))
v <- bind_cols(v,distinct(p %>% select(condition)))

p <- left_join(p,m,by=c("trait"="Met"))
p <- left_join(p,v,by=c("condition"))
p$conditions = factor(p$conditions, levels=c("Marginal","rs370014171","rs8061221","rs12924171","rs370014171 and rs8061221","rs370014171 and rs12924171","rs8061221 and rs12924171","All Three Variants"))
